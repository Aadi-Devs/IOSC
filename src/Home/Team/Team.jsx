...
import Garima_CnD from "../../Assets/team_images/Garima_CnD.jpg";
import Gurleen_Kaur from "../../Assets/team_images/Gurleen_Kaur.jpg";
import Kashaan from "../../Assets/team_images/Kashaan.jpg";
import Kesar_Bansal from "../../Assets/team_images/Kesar_Bansal.jpg";
import Khushi_Chawla from "../../Assets/team_images/Khushi_Chawla.jpg";
import Nikhil_Kaushal from "../../Assets/team_images/Nikhil_Kaushal.jpg";
      ...
      <div className="h-full w-full relative bg-[#000029] overflow-hidden">
        <div className="relative bg-opacity-40 backdrop-blur-md bg-transparent h-[5rem] z-[10]">
          <header className="navbar-smooth flex items-center justify-between bg-opacity-5 text-white">
            <div className="container mx-auto flex items-center h-20">
              <a
                href=""
                className="soc-logo flex items-center justify-center absolute sm:left-4  left-2"
              >
                <img src={Iosclogo} alt="Logo" className="h-14" />
              </a>
              {/* <a
                href=""
                className="soc-logo flex items-center justify-center absolute sm:right-4 right-2"
              >
                <img src={Iosclogo} alt="Logo" className="h-14" />
              </a> */}
            </div>
        ...
        <div className="flex flex-col sm:h-[40rem] h-full w-full justify-center bg-[#000029] sm:gap-0 gap-20">
          <div className="mt-5 flex flex-col items-center justify-center gap-4">
            ...
            {/* <p className="text-white text-2xl">2025</p> */}
          </div>

          <div className="flex sm:flex-row flex-col h-full w-full items-center justify-center sm:gap-0 gap-20">
            <div class="text-center sm:w-1/2 w-full text-gray-500 dark:text-gray-400">
              <div className="mx-auto rounded-full w-72 h-72 overflow-hidden">
                <img
              ...
              {/* <ul class="flex justify-center mt-4 space-x-4">
                <li>
                  ...
                  >
                    <img src={instagram} alt="" className="w-6 hover:scale-110" />
                  </a>
                </li>
                <li>
                  <a
            ...
            <div className="flex sm:flex-row flex-col items-center justify-center w-1/2 h-full gap-20">
              <div class="text-center text-gray-500 dark:text-gray-400">
                <div className="mx-auto mb-4 rounded-full w-60 h-60 overflow-hidden">
                  <img
                    class="mx-auto w-60 h-60 rounded-full object-cover object-center"
                    src={Vishal}
                    alt="Vishal Gupta"
                  />
                </div>
              ...
              <div class="text-center text-gray-500 dark:text-gray-400 mb-10 sm:mb-0">
                <div className="mx-auto mb-4 rounded-full w-60 h-60 overflow-hidden">
                  <img
    ...
    <>
      <section class=" bg-[#000029]">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-8 lg:px-6">
          ...
          <div class="flex flex-col sm:gap-0 gap-20">
            <div className="">
              <div class="text-center text-gray-500 dark:text-gray-400">
                <img
                  className="mx-auto mb-4 w-44 h-44 rounded-full object-cover object-center"
                  src={Bhumik}
                  alt="Bonnie Avatar"
                />
                <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Bhumik Kumar</a>
                </h3>
                <p>President</p>
                {/* <ul class="flex justify-center mt-4 space-x-4">
                  <li>
            ...
            <div className="flex sm:flex-row flex-col items-center justify-center sm:gap-80 gap-20">
              <div class="text-center text-gray-500 dark:text-gray-400">
                <img
                  class="mx-auto mb-4 w-44 h-44 rounded-full object-cover object-center"
                  src={Utkarsh}
                  alt="Utkarsh Saini"
                />
                <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Utkarsh Saini</a>
                </h3>
    ...
    <>
      <section class=" bg-[#000029]">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-8 lg:px-6">
          ...
          <div class="grid gap-20 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 sm:gap-0">
            <div class="text-center text-gray-500 dark:text-gray-400">
              <div className="mx-auto mb-4 rounded-full w-44 h-44 overflow-hidden">
                <img
                  class="mx-auto w-40 h-40 rounded-full object-cover object-center scale-150"
                  src={Priyanshu}
                  alt="Priyanshu Satapathy"
                />
              </div>
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="#">Priyashu Satapathy</a>
              </h3>
              <p>AI-ML Head</p>
              {/* <ul class="flex justify-center mt-4 space-x-4">
                <li>
            ...
            <div class="text-center text-gray-500 dark:text-gray-400">
              <div className="mx-auto mb-4 rounded-full w-44 h-44 overflow-hidden">
                <img
                  ...
                  src={Aditya}
                  alt="Aditya Shrivastav"
                />
              </div>
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="#">Aditya Shrivastav</a>
              </h3>
              <p>WebD Head</p>
              {/* <ul class="flex justify-center mt-4 space-x-4">
                <li>
            ...
            <div class="text-center text-gray-500 dark:text-gray-400">
              <div className="mx-auto mb-4 rounded-full w-44 h-44 overflow-hidden">
                <img
                  class="mx-auto w-40 h-40 rounded-full object-cover object-center scale-125"
                  src={Khushi_Chawla}
                  alt="Khushi Chawla"
                />
              </div>
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                <a href="#">Khushi Chawla</a>
              </h3>
              <p>SM Head</p>
              {/* <ul class="flex justify-center mt-4 space-x-4">
                <li>
